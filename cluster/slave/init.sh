...
sed -i -e 's/_MASTER_HOST_IP/$MASTER_HOST/g' /home/ubuntu/cloud/cluster/slave/docker-compose.yml
docker compose -f /home/ubuntu/cloud/cluster/slave/docker-compose.yml up -d
